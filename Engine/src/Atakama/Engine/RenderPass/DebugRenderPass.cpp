...
void DebugRenderPass::Draw()
{
    ...
    m_SimpleShader->Bind();
    m_SimpleShader->SetUniformMat4("uView", camera.GetViewMatrix());
    ...
    m_PointLightShader->SetUniformMat4("uView", camera.GetViewMatrix());
    ...
    // Camera / View
    m_PointLightShader->SetUniformFloat3("uViewPosition", camera.Transform.Translate);
    // Mesh
